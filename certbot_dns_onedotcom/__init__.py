...
Credentials
-----------
Use of this plugin requires a configuration file containing One.com Remote API
credentials
.. code-block:: ini
   :name: credentials.ini
   :caption: Example credentials file:
   # One.com credentials used by Certbot
   dns_onedotcom_username = myispremoteuser
   dns_onedotcom_password = mysecretpassword
The path to this file can be provided interactively or using the
``--dns-onedotcom-credentials`` command-line argument. Certbot records the path
...
.. code-block:: bash
   ...
   certbot certonly \\
     --dns-onedotcom \\
     --dns-onedotcom-credentials ~/.secrets/certbot/onedotcom.ini \\
     -d example.com
.. code-block:: bash
...
.. code-block:: bash
   ...
   certbot certonly \\
     --dns-onedotcom \\
     --dns-onedotcom-credentials ~/.secrets/certbot/onedotcom.ini \\
     --dns-onedotcom-propagation-seconds 240 \\
     -d example.com
"""